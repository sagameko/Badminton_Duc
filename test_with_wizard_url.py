"""
Test with baf-wizard-currenturl header
"""
...
start_response = client.session.get(
    ...
    params={
        ...
        "zoneTypeId": 28,
        "RedirectUrl": f"{client.base_url}/ClientPortal2/#/FacilityBooking?clubId=1&zoneTypeId=28&sessionId={session_id}"
    }
)
...
if details_response.status_code == 200:
    ...
    print(f"\nStep 3: Confirming with rule {rule_id}...")
